...
from main.views import show_mantap, show_ticket, show_seat,dummy_seat_action,dummy_ticket_action
...
urlpatterns = [
    ...
    path('tickets/action/', dummy_ticket_action, name='ticket_action'),
